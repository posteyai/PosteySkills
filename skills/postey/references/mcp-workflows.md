...
[`setup.md`](../../../setup.md) Step 4 names for the client — the bare
`npx skills add posteyai/skills` installs the hub, every optional pack and this repository's skill
template alongside it, which is why every documented form carries `-s postey`.
